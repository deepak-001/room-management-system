...
class User implements UserInterface {
	 ...
	 *
	 * @ORM\ManyToMany(targetEntity="Reservation\Entity\UserRole", inversedBy="user")
	 ...
	 * Add role
	 *
	 * @param \Reservation\Entity\UserRole $role
	 * @return User
	 */
	public function addRole(\Reservation\Entity\UserRole $role) {
		$this->role[] = $role;
	 ...
	 * @param \Reservation\Entity\UserRole $role
	 */
	public function removeRole(\Reservation\Entity\UserRole $role) {
